...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span
            ...
            <form action="${pageContext.request.contextPath}/manage/admin_douserselect" method="get">
                <table class="search-tab">
                    <tr>
                        ...
                        <td>
                            <select name="search-sort" id="title">
                        ...
                        <th width="70">关键字:</th>
                        <td><input class="common-text" placeholder="关键字" name="keyword" value="${param.keywords}" id="" type="text">
                        </td>
    ...
    <div class="result-wrap">
        <form action="admin_douserdel" name="myform" id="myform" method="post">
            ...
            <div class="result-content">
                ...
                <div class="list-page">
                    一共 ${tsum} 条 ${cpage}/${tpage}页
                    <a href="admin_douserselect?cp=1${searchParams}">首页</a>
                    <a href="admin_douserselect?cp=${cpage-1>0?cpage-1:1}${searchParams}">上一页</a>
