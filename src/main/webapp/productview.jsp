...
<div class="address">
    <div class="wrapper clearfix">
        ...
        <a href="#" class="on">【动漫】${p.PRODUCT_NAME }</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            ...
            <div class="fr intro">
                <div class="title"><h4>【动漫】${p.PRODUCT_NAME }</h4>
    ...
    <div class="msgR fr" style="width:200px;"><h4>为你推荐</h4>
        <div class="seeList">
            ...
            <a href="selectproductview?id=${cp.PRODUCT_ID }">
                <dl>
                    <dt><img src="images/product/${cp.PRODUCT_FILENAME }" width="180" height="150"></dt>
                    <dd>【动漫】${cp.PRODUCT_NAME }</dd>
            ...
            <div class="likeList clearfix">
                <div>
                    ...
                    <a href="selectproductview?id=${lp.PRODUCT_ID }">
                        <dl>
                            <dt><img src="images/product/${lp.PRODUCT_FILENAME } " width="216" height="216"></dt>
                            <dd>【动漫】${lp.PRODUCT_NAME }</dd>
